...
from codes.BandwidthEstimator_heuristic import HeuristicEstimator
import logging
...
def load_active_model(active_model_file='active_model'):
    with open(r"/usr/lib/python3/dist-packages/codes/active_model", 'r') as f:
        try:
            model=f.read().strip()
...
class Estimator(object):
    def __init__(self, model_path="/usr/lib/python3/dist-packages/codes/model/bob_2022_02_23.pth", step_time=60): # Make sure to push model and change the name of the model
        # model parameters
        state_dim = 11
        action_dim = 4
        ...
        FactorH = 1.1
        # load model
        model_path = r"/usr/lib/python3/dist-packages/codes/model/bob_2022_02_23.pth"
